...
AD_BOT_PORT = 19961
domain_controller = 'DC=pyad01,DC=com'
...
def create_user(username, display_name, department,  active=False):
    """
...
# Enable, disables & deletes User
# Mode options DISABLE, ENABLE, DELETE
